...
A RESTful API using Spring Boot, JPA, and Postgresql. Specifically, implements an API that exposes operations for social media data that resembles the conceptual model of Twitter.
